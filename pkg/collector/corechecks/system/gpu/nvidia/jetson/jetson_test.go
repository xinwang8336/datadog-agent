...
func TestNano(t *testing.T) {
	...
	mock.On("Gauge", "nvidia.jetson.gpu.mem.used", 534.0*mb, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.mem.total", 3964.0*mb, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.mem.n_lfb", 98.0, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.mem.lfb", 4.0*mb, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.swap.used", 5.0*mb, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.swap.total", 1982.0*mb, "", []string(nil)).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.swap.cached", 1.0*mb, "", []string(nil)).Return().Times(1)
	...
	mock.On("Gauge", "nvidia.jetson.gpu.emc.freq", 204.0, "", []string(nil)).Return().Times(1)
	...
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 39.5, "", []string{"zone:AO"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 36.5, "", []string{"zone:CPU"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 36.0, "", []string{"zone:GPU"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 34.0, "", []string{"zone:PLL"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 100.0, "", []string{"zone:PMIC"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.temp", 36.25, "", []string{"zone:thermal"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.vdd.instant", 1022.0, "", []string{"probe:POM_5V_IN"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.vdd.average", 1022.0, "", []string{"probe:POM_5V_IN"}).Return().Times(1)
	...
	mock.On("Gauge", "nvidia.jetson.gpu.vdd.instant", 204.0, "", []string{"probe:POM_5V_CPU"}).Return().Times(1)
	mock.On("Gauge", "nvidia.jetson.gpu.vdd.average", 204.0, "", []string{"probe:POM_5V_CPU"}).Return().Times(1)
