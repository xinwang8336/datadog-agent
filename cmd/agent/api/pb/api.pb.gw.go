...
var (
	pattern_AgentSecure_TaggerStreamEntities_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "grpc", "stream_tags"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AgentSecure_TaggerFetchEntity_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "grpc", "fetch_entity"}, "", runtime.AssumeColonVerbOpt(true)))
)
